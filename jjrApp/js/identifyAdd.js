$(function() {
    var thisAgencyName='',//	是	string	公司名
        ...
        thisInfoId,
        thisMemberId=location.search.slice(1).split('=')[1],//	是	string	经纪人id
    ...
    $('#modifyBtn').click(function() {
        if(localStorage.getItem('urlDataApp')){
            imgUrlArr=localStorage.getItem('urlDataApp').split(',');//图片
        }
        if(localStorage.getItem('imgNamesApp')){
            imgNames=localStorage.getItem('imgNamesApp').split(',');//图片名
        }
        thisInfoId=localStorage.getItem('infoIdApp');//信息id
        thisCityName=localStorage.getItem('cityNameApp');//城市
        thisAreaName=localStorage.getItem('boroughNameApp');//区域
    });
