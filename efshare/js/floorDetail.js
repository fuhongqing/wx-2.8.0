$(function () {
    ...
    var floorUrl = 'http://agentapi.ehaofang.com/',//'http://jjrtest.ehaofang.com/',//'http://agentapi.ehaofang.com/'
        ...
        memberId =searchArr[1].split('=')[1],// 2140,//
        sign =1,// 1,//
        userType =1,// 2,//
        propertyName = '';
            ...
            success: function (data) {
                ...
                if (propertyImageData.effectImage && effectImage) {
                    for (var i = 0, l = effectImage; i < l; i++) {
                        list.push("<li class='swiper-slide'><img src='" + propertyImageData.effectImage[i]["imageUrl"] + "' ></li>");
                    }
                ...
                if (propertyImageData.trafficImage && trafficImage) {
                    for (var i = 0, l = trafficImage; i < l; i++) {
                        list.push("<li class='swiper-slide'><img src='" + propertyImageData.trafficImage[i]["imageUrl"] + "' ></li>");
                    }
                ...
                if (propertyImageData.realSceneImage && realSceneImage) {
                    for (var i = 0, l = realSceneImage; i < l; i++) {
                        list.push("<li class='swiper-slide'><img src='" + propertyImageData.realSceneImage[i]["imageUrl"] + "' ></li>");
                    }
                ...
                if (propertyImageData.sampleImage && sampleImage) {
                    for (var i = 0, l = sampleImage; i < l; i++) {
                        list.push("<li class='swiper-slide'><img src='" + propertyImageData.sampleImage[i]["imageUrl"] + "' ></li>");
                    }
    ...
    function getFloorDetail(res) {
        $.ajax({
            ...
            success: function (data) {
                ...
                var agentDetails = data.data.agentDetails;
                ...
                if(agentDetails.length){
                    if (!agentDetails[0].name) {
                        agentDetails[0].name = '';
                    }
                    if (!agentDetails[0].phone) {
                        agentDetails[0].phone = '';
                    }
                    var consultHtml = `
                    <div>
                      <span>${agentDetails[0].name } ${agentDetails[0].phone}</span>
                    </div>
                    <div id="tel"><a href="tel:${agentDetails[0].phone}">联系他</a></div>
                    `;
